 ...
 */
export function clean(markdown) {
    return markdown
...
export function smart_quotes(str, { first = true, html = false } = {}) {
    ...
    return str.replace(html ? /(.|^)(&#39;|&quot;)(.|$)/g : /(.|^)('|")(.|$)/g, (m, before, quote, after) => {
...
export async function transform(markdown, { walkTokens, ...renderer } = {}) {
 ...
 */
export function strip_origin(str) {
    return str.replaceAll('https://econic.ai', '');
}
